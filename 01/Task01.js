...
const Task01 = () => {
    ...
    subject.subscribe(({timeStamp}) => setTime( parseInt(timeStamp / 1000) ))
    subject.subscribe(({target}) => setTagName(target.tagName))
    subject.subscribe(({pageX,pageY}) => setCursorPosition(`[${pageX},${pageY}]`)) 
